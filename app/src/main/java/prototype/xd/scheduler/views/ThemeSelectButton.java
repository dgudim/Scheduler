...
import static prototype.xd.scheduler.utilities.Static.APP_THEME_DARK;
import static prototype.xd.scheduler.utilities.Static.APP_THEME_LIGHT;
import static prototype.xd.scheduler.utilities.Static.APP_THEME_SYSTEM;
import static prototype.xd.scheduler.utilities.Static.DEFAULT_APP_THEME;
import static prototype.xd.scheduler.utilities.Static.APP_THEMES;
...
public class ThemeSelectButton extends MaterialButton {
    ...
    public ThemeSelectButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            themeId.set(Static.APP_THEME.get());
            ...
            setOnClickListener(v -> {
                ...
                Static.APP_THEME.put(themeId.get());
