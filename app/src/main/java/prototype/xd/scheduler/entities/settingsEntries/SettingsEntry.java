...
enum SettingsEntryType {CALENDAR_ACCOUNT, CALENDAR, COMPOUND_CUSTOMIZATION, RESET_BUTTONS, SEEK_BAR, SEEK_BAR_DISCRETE, SWITCH, TITLE_BAR, ADAPTIVE_BACKGROUND_SETTINGS}
