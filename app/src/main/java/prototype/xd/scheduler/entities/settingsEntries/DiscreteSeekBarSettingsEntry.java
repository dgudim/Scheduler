...
public class DiscreteSeekBarSettingsEntry extends SeekBarSettingsEntry{
    public DiscreteSeekBarSettingsEntry(int seek_min, int seek_max, int defaultValue, String key, int stringResource) {
        super(seek_min, seek_max, defaultValue, key, stringResource);
