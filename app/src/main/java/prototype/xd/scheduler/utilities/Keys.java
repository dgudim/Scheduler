...
public class Keys {
    ...
    public static final int SETTINGS_DEFAULT_NEW_BG_COLOR = 0xff_CCFFCC;
    public static final int SETTINGS_DEFAULT_OLD_BG_COLOR = 0xff_FFCCCC;
    
    public static final int SETTINGS_DEFAULT_TODAY_BEVEL_COLOR = 0xff_888888;
    public static final int SETTINGS_DEFAULT_NEW_BEVEL_COLOR = 0xff_88FF88;
    public static final int SETTINGS_DEFAULT_OLD_BEVEL_COLOR = 0xff_FF8888;
    
    public static final int SETTINGS_DEFAULT_TODAY_BEVEL_THICKNESS = 5;
    public static final int SETTINGS_DEFAULT_NEW_BEVEL_THICKNESS = 5;
    public static final int SETTINGS_DEFAULT_OLD_BEVEL_THICKNESS = 5;
    
    public static final int SETTINGS_DEFAULT_TODAY_FONT_COLOR = 0xff_000000;
    public static final int SETTINGS_DEFAULT_NEW_FONT_COLOR = 0xff_005500;
    public static final int SETTINGS_DEFAULT_OLD_FONT_COLOR = 0xff_990000;
